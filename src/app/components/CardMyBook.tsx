...
export default function CardMyBook(props: any) {
    ...
    >
      ...
      <div className="flex items-center justify-between">
        ...
        <Modal show={openModal} onClose={() => setOpenModal(false)}>
          <Modal.Header>Are you sure want to cancel ?</Modal.Header>
          <Modal.Body>
            <div className="space-y-6">
              <p className="text-base leading-relaxed text-gray-500 dark:text-gray-400">
                Your point will be back like before.
              </p>
            </div>
          </Modal.Body>
          <Modal.Footer>
            <Button
              onClick={() => {
                ...
                fetch(`${BASE_URL}/api/orders/${props.book.order.id}/cancel`, {
                  method: "PUT",
                  headers: {
